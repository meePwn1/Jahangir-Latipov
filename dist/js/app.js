 ...
 */
    ...
    (() => {
        ...
        if (inputTel.length) modules_flsModules.inputmask = Inputmask("+\\9\\9\\8 99 999-99-99", {
            placeholder: "-"
        }).mask(inputTel);
        ...
        function initSliders() {
            if (document.querySelector(".get-page__body") && window.innerWidth <= 991.98) {
                const sliderGet = new core(".get-page__body", {
                    modules: [ Scrollbar ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1.1,
            ...
            if (document.querySelector(".guest-page__slider")) {
                const sliderGuest = new core(".guest-page__slider", {
                    modules: [ Scrollbar ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
            ...
            if (document.querySelector(".past-page__slider")) {
                const sliderPast = new core(".past-page__slider", {
                    modules: [ Scrollbar ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
            ...
            if (document.querySelector(".student-review__slider")) new core(".student-review__slider", {
            ...
            if (document.querySelector(".client-review__slider")) {
                const sliderReview = new core(".client-review__slider", {
        ...
        function setIndicator(indicator, slider) {
            ...
            if (slider.realIndex == slider.slides.length - 1 || 0 == slider.realIndex) {
                ...
                indicatorLine.style.width = `${1 * slider.progress * offsetWidthIndicator}px`;
                indicatorCircle.style.left = `${1 * slider.progress * offsetWidthIndicator}px`;
            }
        }
